...
export function LogoCloud({ className, ...props }: LogoCloudProps) {
  return (
    ...
    >
      ...
      >
        <PlusIcon
          className="-right-[12.5px] -bottom-[12.5px] absolute z-10 size-6 text-charcoal/30"
          strokeWidth={1}
        />
      </LogoCard>
      ...
      >
        ...
        />
        <PlusIcon
          className="-bottom-[12.5px] -left-[12.5px] absolute z-10 hidden size-6 md:block text-charcoal/30"
          strokeWidth={1}
        />
      </LogoCard>
      ...
      >
        <PlusIcon
          className="-right-[12.5px] -bottom-[12.5px] md:-left-[12.5px] absolute z-10 size-6 md:hidden text-charcoal/30"
          strokeWidth={1}
        />
      </LogoCard>
...
function LogoCard({ logo, className, children, ...props }: LogoCardProps) {
  return (
    ...
    >
      <img
        alt={logo.alt}
        className="pointer-events-none h-4 select-none md:h-5 mix-blend-multiply opacity-50"
